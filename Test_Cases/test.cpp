...
{
	string str = "B+"; //A+ and B+ are also acceptable. if your output is A+ or B+ on this input then change the value of str accordingly and your test will be passed 
